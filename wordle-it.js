this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
  ...
  Sa.innerHTML = '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Para machos</div>\n          <div class="description">No entiendo nada pero es más difícil</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Look pobre</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Para putos ciegos</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">No te metás</div>\n        </div>\n        <div class="control">\n          <a href="https://github.com/ramiror/wordle-it/issues/new" target="blank" title="github.com/ramiror/wordle-it">Github</a>\n          |\n          <a href="https://twitter.com/intent/tweet?screen_name=racter" target="blank" title="@racter">Twitter</a>\n        </div>\n      </div>\n    </section>\n  </div>\n  <div id="footnote">\n    <div id="puzzle-number"></div>\n    <div id="hash"></div>\n  <div>\n';
  var _a = function(e) {
      n(t, e);
      var a = h(t);
  ...
  var Qa = "IN_PROGRESS",
      Za = "WIN",
      es = "FAIL",
      as = ["Tinchazooo!!!", "Tercer tiemo ea! ea!", "Notevole", "Ottimo", "Non male", "Daje!"],
      ss = function(e) {
          n(t, e);
          var a = h(t);
          ...
          return o(t, [{
              ...
              value: function() {
                  if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                      ...
                      if (e = s, !La.includes(e) && !Aa.includes(e)) return a.setAttribute("invalid", ""), void this.addToast("Un tincho no entendería eso");
                      if (this.hardMode) {
              ...
              value: function() {
                  ...
                  this.$game.addEventListener("game-key-press", (function(a) {
                      ...
                      var s = e.$game.querySelector("game-page"),
                          t = document.createTextNode("Cómo Tinchear");
                      s.appendChild(t);
  ...
  var hs = {
          currentStreak: "Racha",
          maxStreak: "Racha histórica",
          winPercentage: "% supremacía",
          gamesPlayed: "Partidos",
          gamesWon: "Wins",
          averageGuesses: "Promedio de supremacía"
      },
      ys = function(e) {
          n(t, e);
          var a = h(t);
